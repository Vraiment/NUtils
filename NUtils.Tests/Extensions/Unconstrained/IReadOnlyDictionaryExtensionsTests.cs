...
namespace NUtils.Tests.Extensions.Unconstrained
{
    class IReadOnlyDictionaryExtensionsTests
    {
        ...
        {
            IReadOnlyDictionary<int, string> dictionary = SampleDictionary();
            IReadOnlyDictionary<int, string> expected = SampleDictionary();
        ...
        private static IReadOnlyDictionary<int, string> SampleDictionary() => new Dictionary<int, string>
        {
            [10] = "value1",
            [11] = "value2",
            [12] = "value3"
