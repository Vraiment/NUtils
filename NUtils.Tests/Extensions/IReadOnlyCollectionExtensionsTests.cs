...
{
    class IReadOnlyCollectionExtensionsTests
    {
        #region Get method
        [Test]
        public void Test_Get_With_Valid_Index()
        {
            IReadOnlyCollection<char> collection = SampleCollection();
        ...
        {
            IReadOnlyCollection<char> collection = null;
        ...
        {
            IReadOnlyCollection<char> collection = EmptyCollection();
            Action action = () => collection.Get(0);
        ...
        {
            IReadOnlyCollection<char> enumerable = SampleCollection();
        ...
        {
            IReadOnlyCollection<char> enumerable = EmptyCollection();
        ...
        private static IReadOnlyCollection<char> EmptyCollection()
            => Array.Empty<char>();

        private static IReadOnlyCollection<char> SampleCollection()
            => new char[] { 'a', 'b', 'c', 'd' };
    }
}
