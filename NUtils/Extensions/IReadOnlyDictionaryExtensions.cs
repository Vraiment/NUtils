...
namespace NUtils.Extensions
{
    ...
    public static class IReadOnlyDictionaryWithClassValuesExtensions
    {
        /// <summary>
        ...
        /// </exception>
        public static TValue Get<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key) where TKey : class
        {
            Validate.ArgumentNotNull(dictionary, nameof(dictionary));
        ...
        /// If either <paramref name="dictionary"/> or <paramref name="key"/> are null.
        /// </exception>
        public static TValue GetOrElse<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key, TValue value) where TKey : class
        {
            Validate.ArgumentNotNull(dictionary, nameof(dictionary));
            Validate.ArgumentNotNull(key, nameof(key));
    ...
    public static class IReadOnlyDictionaryWithStructsValuesExtensions
    {
        /// <summary>
        /// Retrieves the value with key <paramref name="key"/> from <paramref name="dictionary"/>.
        /// </summary>
        ...
        /// </exception>
        public static TValue Get<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key) where TKey : struct
        {
            Validate.ArgumentNotNull(dictionary, nameof(dictionary));
        ...
        /// If either <paramref name="dictionary"/> is null.
        /// </exception>
        public static TValue GetOrElse<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key, TValue value) where TKey : struct
        {
            Validate.ArgumentNotNull(dictionary, nameof(dictionary));
